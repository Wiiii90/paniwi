...
export type SyncSourceMode = SourceName | "api-football-enrich";

const sourceMap: Record<SyncSourceMode, GoalSource> = {
  mock: mockSource,
  "api-football": apiFootballSource,
  "api-football-enrich": apiFootballSource,
